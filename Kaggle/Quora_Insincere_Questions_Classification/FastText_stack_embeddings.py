...
print("F1 stimaded on the epoch",np.mean(model.history.history['f1_b']))
print(model.summary())
...
##############################################################################################
#####################Report ##################################################################
#Embeddings fatText + Wiki News
# nhid 64 ,nlayes=2,clr_exp, 

#F1 Prediction  0.6761611282307542
#F1 stimaded on the epoch 0.6165670828680218

# Archiqueture 
#model = Sequential()
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNLSTM(64, return_sequences=True,input_shape=(45,700))))
...
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNLSTM(128, return_sequences=True,input_shape=(45,700))))
#model.add(Bidirectional(CuDNNLSTM(64)))
#model.add(Dropout(0.5))
#model.add(Dense(1, activation="sigmoid"))
#model.compile(loss='binary_crossentropy',
...
#F1 Prediction  0.6776056257503859
#F1 stimaded on the epoch 0.6182699072681928

#################################################
#model = Sequential()
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNLSTM(256, return_sequences=True,input_shape=(45,700))))
...
#F1 Prediction  0.6748717388931339
#F1 stimaded on the epoch 0.6216642699201458
###################################################3

#model = Sequential()
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNLSTM(350, return_sequences=True,input_shape=(45,700))))
#model.add(Bidirectional(CuDNNLSTM(64)))
#model.add(Dropout(0.5))
#model.add(Dense(1, activation="sigmoid"))
#model.compile(loss='binary_crossentropy',
...
#F1 Prediction  0.6680310663308144
#F1 stimaded on the epoch 0.6166736998511386
...
#F1 Prediction  0.6776155376811188
#F1 stimaded on the epoch 0.6192121163045258
...
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNLSTM(350, return_sequences=True,input_shape=(45,700))))
#model.add(Bidirectional(CuDNNLSTM(350)))
#model.add(Dropout(0.5))
#model.add(Dense(1, activation="sigmoid"))
#model.compile(loss='binary_crossentropy',
#              optimizer='adam',
...
#F1 Prediction  0.6749182361565355
#F1 stimaded on the epoch 0.6233347485414813

###################################################
#model = Sequential()
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNGRU(128, return_sequences=True,input_shape=(45,700))))
...
#F1 Prediction  0.6772741790308062
#F1 stimaded on the epoch 0.613954343584185
...
#model.add(Embedding(Max_Emb, 700,weights=[Embedding_General],trainable=False))
#model.add(Dropout(0.5))
#model.add(Bidirectional(CuDNNGRU(64, return_sequences=True,input_shape=(45,700))))
...
#F1 Prediction  0.6718264566414127
#F1 stimaded on the epoch 0.6142622506206467              
...
#F1 Prediction  0.6795760972091217
#F1 stimaded on the epoch 0.6208859026727821
...
#F1 Prediction  0.6700034795642514
#F1 stimaded on the epoch 0.6178978216188831              
